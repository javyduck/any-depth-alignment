#!/usr/bin/env bash
# =============================================================================
# E2 — classifier-guardrail baselines over deep-prefill depth.
# =============================================================================
...
# one the E2 plotter reads (plot_e2_prefill.GUARDRAIL_GENERATOR). GENERATOR also
...
: "${GENERATOR:=meta-llama/Llama-3.1-8B-Instruct}"   # must match plot_e2_prefill.GUARDRAIL_GENERATOR
