...
The E3 experiments (§ Robustness Under Adversarial Prompt Attacks) run four
...
1. Generate raw attacks: `scripts/30_e3_run_attacks.sh` (drives the four engines
...
3. Evaluate ADA + baselines on the attacked prompts: `scripts/31_e3_eval.sh`.
